  ...
  <div class="container" style="width: 50%">
    ...
    // mostrar preu total i el botó per comprar
      ...
      <form action="crear_comanda.php" method="POST">
        <input type="hidden" name="preu" value="<?php echo $preuCarro ?>">
        <label><b style="font-size: 1.5vw">Targeta de crèdit</b></label>
        <input type="text" name="targeta" placeholder="Deixa en blanc si pagaràs en efectiu">
      ...
      <a href="productes.php"><h3 style="font-size: 3vw">No tens gana?</h3></a>
      <?php
    }
    ?>
  </div>
